\chapter{Wstęp i cel pracy (Konrad Czarnecki)}
...
\end{quotation}
Podział prac przedstawiono w tabeli \ref{tab:podzial_prac}.
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|p{10cm}|}
        \hline
        \textbf{Imię i nazwisko} & \textbf{Zakres prac} \\
        \hline
        Jan Walczak &
        Opracowanie i implementacja zadań: 

        \quad • 2 (Planimetria) 

        \quad • 7 (Liczby rzeczywiste i działania na zbiorach liczbowych) 

        \quad • 9 (Ciągi liczbowe) 

        \quad • 13 (Stereometria)
        
        Koordynacja prac
        
        Zarządzanie projektem na GitHubie
        
        Scalanie zagadek i integracja z systemem CAVE\\
        \hline
        Konrad Czarnecki &
        Opracowanie i implementacja zadań: 
        ...
        \quad • 5 (Geometria analityczna) 

        \quad • 8 (Znaki funkcji trygonometrycznych) 

        Implementacja funkcji obracania pokoju o 90 stopni
        ...
        \quad • 1 (Wzory skróconego mnożenia) 

        \quad • 6 (Kombinatoryka) 

        \quad • 10 (Prawdopodobieństwo) 

        \quad • 11 (Optymalizacja i rachunek różniczkowy) 

        \quad • 12 (Układy równań)
