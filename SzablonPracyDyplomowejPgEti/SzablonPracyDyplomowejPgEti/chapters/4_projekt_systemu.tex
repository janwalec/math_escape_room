...
Pierwsze z zadań wirtualnego escape roomu opiera się na klasycznej mechanice gry logicznej „piętnastki”, zaadaptowanej do środowiska matematycznego. Po aktywacji centralnego stołu w wirtualnym pomieszczeniu, na jego powierzchni pojawia się plansza o wymiarach 7×7, zawierająca kafelki z symbolami matematycznymi i wyrażeniami algebraicznymi. Na kafelkach umieszczono między innymi litery zmiennych (a, b), symbole potęg (², ³), operatory działań matematycznych (+, −, =), nawiasy oraz złożone wyrażenia typu 2ab, ab² czy a³. Pod planszą wyświetlana jest lista nazw siedmiu wzorów skróconego mnożenia, takich jak: „Kwadrat sumy”, „Kwadrat różnicy”, „Różnica kwadratów” czy „Suma sześcianów”. W treści zadania nie podano jednak pełnych wzorów, co zmusza graczy do samodzielnego przypomnienia ich z wiedzy szkolnej. Celem użytkownika jest ułożenie siedmiu pełnych wyrażeń odpowiadających tym wzorom, poprzez przesuwanie kafelków na planszy i formowanie poprawnych układów w pionie lub poziomie, zgodnie z zasadami klasycznej gry „piętnastki”. System automatycznie rozpoznaje poprawnie ułożone wzory i oznacza je na liście oraz na planszy. Zadanie można rozwiązywać w dowolnej kolejności, a jego ukończenie następuje po poprawnym ułożeniu wszystkich siedmiu wyrażeń.
