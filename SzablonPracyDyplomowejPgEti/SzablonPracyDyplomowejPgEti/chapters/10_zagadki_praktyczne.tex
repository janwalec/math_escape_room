...
Zadaniem głównego kontrolera jest zarządzanie przebiegiem całego zadania. Porusza kostką w kiedunkach wskazanych
...
względem kafelków, niezależnie od jej fizycznego położenia w świecie gry, gdyż te może być niewystarczająco
...
W związku z faktem, że zbiory liczb spełniajace układ nierówności różnią się w zależności od układu, który zostanie
...
po kafelkach, których liczby spełniają wylosowaną nierówność. Jeśli kostka stanie na kafelku, który niespełnia
